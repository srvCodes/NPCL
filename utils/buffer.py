...
class Buffer:
    ...
    def __init__(self, buffer_size, device, n_tasks=None, mode='reservoir'):
        ...
        self.attributes = ['examples', 'labels', 'logits', 'task_labels', 'task_logits']
    ...
    def init_tensors(self, examples: torch.Tensor, labels: torch.Tensor,
                     logits: torch.Tensor, task_labels: torch.Tensor, task_logits: torch.Tensor) -> None:
        """
    ...
    def add_data(self, examples, labels=None, logits=None, task_labels=None, task_logits=None):
        """
        ...
        if not hasattr(self, 'examples'):
            self.init_tensors(examples, labels, logits, task_labels, task_logits)
        ...
        for i in range(examples.shape[0]):
            ...
            if index >= 0:
                ...
                if task_logits is not None:
                    self.task_logits[index] = task_logits[i].to(self.device)
